...
create unique index i_operm on operm (id_user, id_obj, id_class); ';
    ...
    {
        $octrl = new ControlObject($this->dbaccess, array(
            $this->id_obj,
            $this->id_class
        ));
    ...
    function GetGroupPrivileges()
    {
        ...
        $result = pg_exec($this->init_dbid() , "select getprivilege({$this->id_user},{$this->id_obj},{$this->id_class},true)");
    ...
    function GetPrivileges()
    {
        ...
        $result = pg_exec($this->init_dbid() , "select getprivilege({$this->id_user},{$this->id_obj},{$this->id_class},false)");
    ...
    function ControlOid($idclassapp, $method)
    {
        ...
        if (!$this->HasPrivilege($acl->id)) {
            $err = sprintf(_("Object Permission : permission %s needed (%s) - # %d") , _($acl->description) , $this->GetDescription() , $this->id_obj);
