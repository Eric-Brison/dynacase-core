 ...
 * by throwing exceptions, with corresponding JSON error constant,
...
class JSONCodec
{
     ...
     * @throws Exception exception is throwned on error
     */
    public function decode($json, $assoc = false, $depth = 512)
    {
        ...
        if ($o === null) {
            ...
            throw new Exception($this->getErrorMsg($errCode));
        }
        return $o;
    }
