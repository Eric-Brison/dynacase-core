...
class BasicAttribute
{
    ...
    function inArray()
    {
        if (isset($this->fieldSet) && $this->fieldSet->type == "array") return true;
            ...
            case 'docid':
                if (!$v) {
                    ...
                    if ($info) {
                        ...
                        if ($this->isMultiple() && $v[0] === '{') {
                            $v = Doc::rawValueToArray($v);
                        }
                        ...
                        if (!is_array($v)) {
                            ...
                            $mId = array();
                            $foundName = false;
                            $isMul2 = $this->isMultipleInArray();
                            foreach ($tids as $id) {
                                if ($id === null && $isMul2) continue;
