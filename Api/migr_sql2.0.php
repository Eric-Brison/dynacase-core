...
$table = ($usage->addOptionalParameter("table", "Migrate table?", array("yes", "no"), "no") == "yes"); //
$perm = ($usage->addOptionalParameter("perm", "Migrate permission", array("yes", "no"), "no") == "yes"); //
