 ...
 */
 /**
 */
ini_set("include_path", ".:/var/www/platform3.2:/var/www/platform3.2/WHAT:/usr/share/php");
...
$usage = new ApiUsage();
$usage->setText("Construct vault index database");
$usage->verify();
...
function UpdateVaultIndex($i, DOC &$doc, DocVaultIndex &$dvi) {
  $vl = ""; $vic=0;
