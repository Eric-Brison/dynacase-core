...
$usage->setText("Update the SQL structure of a table of a DbObj Object");
$appclass = $usage->addOption('appc', "application class folder", null, 'WHAT');
$class = $usage->addNeeded('class', 'Class name');
$db = $usage->addOption('dbcoord', "Database name", null, getDbAccess());
