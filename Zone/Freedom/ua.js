...
function defaultOnError(msg, url, line)
{
	...
	if (top.location.href.indexOf('_files/errors/') == -1)
		top.location = '/evangelism/xbProjects/_files/errors/index.html?msg=' + encodeURI(msg) + '&url=' + encodeURI(url) + '&line=' + encodeURI(line);
}
...
function reportError(message)
{
	// customize this for your site
	if (top.location.href.indexOf('_files/errors/') == -1)
		top.location = '/evangelism/xbProjects/_files/errors/index.html?msg=' + encodeURI(message);
}
...
function pageRequires(cond, msg, redirectTo)
{
	if (!cond)
	{
		...
		top.location = redirectTo + '?msg=' + encodeURI(msg);
	}
