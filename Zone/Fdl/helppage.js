...
//Timeout so that document is ready
   setTimeout(function () {helppage.editsection.view(Ih.callOpener('helpcallGetCurrentSectionLang', helppage.editsection.seckey));}, 0);
};
