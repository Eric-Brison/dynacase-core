...
pgservice_core=`php -r "require('$wpub/context/dbaccess.php');echo\\\$pgservice_core;" 2> /dev/null`
if [ $? -ne 0 ]; then
...
pgservice_freedom=`php -r "require('$wpub/context/dbaccess.php');echo\\\$pgservice_freedom;" 2> /dev/null`
if [ $? -ne 0 ]; then
...
freedom_context=`php -r "require('$wpub/context/dbaccess.php');echo\\\$freedom_context;" 2> /dev/null`
if [ $? -ne 0 ]; then
