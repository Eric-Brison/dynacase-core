...
function getpopupfamdetail(Action & $action, $docid)
{
    ...
    $tlink = array(
        ...
        "editprof" => array(
            "descr" => _("Change profile of family document") ,
        ...
        "editcprof" => array(
            "descr" => _("Change profile for new documents") ,
