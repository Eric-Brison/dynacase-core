...
function getpopupdocdetail(&$action,$docid) {
  ...
  $tlink=array_merge($tlink,  array(
	       ...
	       "privateprof"=>array( "descr"=>_("Set private"),
				  ...
				  "submenu"=>"security",
				  "barmenu"=>"false"),
	       "specprof"=>array( "descr"=>_("Set autonome profil"),
	       ...
	       "addpostit"=>array( "descr"=>_("Add postit"),
				   ...
				   "submenu"=>"",
				   "barmenu"=>"false"),   
	       "viewask"=>array( "descr"=>_("View my ask"),
				   ...
				   "submenu"=>"",
				   "barmenu"=>"false"),
	       "viewanswers"=>array( "descr"=>_("View answers"),
...
function addStatesPopup(&$tlink,&$doc) {
  ...
  if ($doc->wid > 0 )  {
	...
	if ((! $tr["nr"]) || (is_array($tr["ask"]) && (count($tr["ask"])>0))) {
      ...
      $tlink[$v]=array( "title"=>$wdoc->getActivity($v,ucfirst(_($v))),
